...
@NamedQueries({
    ...
    , @NamedQuery(name = "Categorie.findByCreateat", query = "SELECT c FROM Categorie c WHERE c.createat = :createat")})
public class Categorie implements Serializable {
    ...
    public Categorie(Integer id, String nom, Date createat) {
        this.id = id;
        this.nom = nom;
